...
MESSAGES = {
    ...
    "keyboards": {
        ...
        "overview": {
            ...
            "dot": ".",
            "title": "📰 Огляд джерел",
            "no_groups": "❌ Немає активних груп",
            "groups_count": "📊 Знайдено груп: {count}",
            "sources_count": "📊 Всього джерел: {count}",
        },
    ...
    "admin": {
        ...
        "activ_only_supergroup": "<b>❌ Звичайні групи не підтримуються!</b>\n\n"
                                 "Бот працює <b>тільки з СУПЕРГРУПАМИ (Форумами)</b> Telegram.\n\n"
                                 "<b>Як виправити:</b>\n"
                                 "1. Відкрийте налаштування групи\n"
                                 "2. Увімкніть опцію «Теми» (Форуми)\n"
                                 "3. Група автоматично стане супергрупою\n"
                                 "4. Повторно введіть команду /activ\n\n"
                                 "⚠️ Після увімкнення тем цю дію неможливо скасувати.",
        
        # ✅ НОВИЙ КЛЮЧ: повідомлення в ЛС після активації групи
        ...
        "plus_enter_name": "<b>📝 Введіть назву теми:</b>\n\n"
                           "Наприклад: <i>Флуділка, Новини, Обговорення</i>\n\n"
                           "Надішліть назву текстом або натисніть 'Скасувати' для відміни.",
        "plus_name_too_short": "❌ Назва теми має бути не менше 1 символу.",
        "plus_name_too_long": "❌ Назва теми має бути не більше 128 символів.",
        "plus_cancelled": "❌ Реєстрацію теми скасовано.",
        ...
        "plus_prompt_simple": "📝 <b>Введіть назву топіка</b>",
        "plus_prompt_placeholder": "Наприклад: Флуділка, Новини, Обговорення...",
    ...
    "sources": {
        ...
        "source_checking": "🔍 <b>Перевіряю джерело...</b>",
    ...
    "settings": {
        ...
        "support_menu_prompt": "Якщо бот приносить вам користь, ви можете подякувати розробнику.\n\n"
                               ...
                               "Оберіть суму:",
        "support_invoice_title": "💎 Підтримати автора",
        "support_invoice_description": "Подяка за розробку MyAggryBot",
    ...
    # ========== MIDDLEWARE MESSAGES ==========
    "middleware": {
        # Для команд, викликаних в ЛС, але призначених для груп
        "group_only_command": (
        ...
        # Для команд, викликаних в групах, але призначених для ЛС
