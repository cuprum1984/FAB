...
MESSAGES = {
    ...
    "keyboards": {
        ...
        "settings_menu": {
            ...
            "legal_terms": "📋 Умови та конфіденційність",
    ...
    "sources": {
        ...
        "source_blocked": "⛔ Адміністратор каналу <b>@{username}</b> не бажає, щоб MyAggryBot парсив його контент. Це джерело заблоковано за проханням автора.",
    ...
    "settings": {
        "title": "<b>⚙️ Налаштування</b>\n\n"
                 "Використовуйте команду /settings для зміни налаштувань.",

        "support_button": "💎 Підтримати автора",
        "support_menu_title": "💎 Підтримати автора",
        "support_menu_prompt": "Якщо бот приносить вам користь, ви можете подякувати розробнику.\n\n"
        ...
        "delete_warning": "<b>⚠️ УВАГА!</b>\n\n"
                          ...
                          "• 👥 Групи, де ви власник (ВИДАЛЕННЯ груп!)\n"
                          "• 🗨️ Теми, які ви створили\n"
                          "• ⚙️ Всі налаштування\n"
                          "• 💾 Весь кеш\n"
                          "• 📝 Ваш акаунт в боті\n\n"
                          "<b>Цю дію НЕМОЖЛИВО скасувати!</b>\n\n"
                          "Групи, де ви не власник, залишаться активними для інших користувачів.\n\n"
                          "Ви впевнені?",
    ...
    # ========== LEGAL (GDPR consent) ==========
    "legal": {
        "welcome_title": "📋 Ласкаво просимо до MyAggryBot!",
        "welcome_text": "<b>🤖 MyAggryBot</b> агрегує контент з Telegram та YouTube,\n"
                        "публікує у ваші групи.\n\n"
                        "<b>Ми збираємо:</b>\n"
                        "• Telegram ID та username\n"
                        "• Мова інтерфейсу\n"
                        "• Дата активності\n\n"
                        "<b>Використовуємо для:</b>\n"
                        "• Роботи бота\n"
                        "• GDPR-очищення (30 днів)\n"
                        "• Статистики (анонімно)\n\n"
                        "Натисніть «✅ Зрозуміло», щоб прийняти умови.",
        "read_terms": "📄 Повні умови",
        "consent_accept": "✅ Зрозуміло, приймаю",
        "back_to_settings": "← Назад в налаштування",
        "consent_success": "✅ Згода підтверджена!",
        "legal_title": "📄 Умови використання та Політика конфіденційності",
    },
}
