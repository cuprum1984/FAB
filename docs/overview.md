...
**Дата отчёта:** 19 апреля 2026
**Версия проекта:** 6.9.6 ✅ **Актуальная**
...
|--------|------|-----------|--------|
| **6.9.6** | 19 апр 2026 | **Локализация кнопки "Поддержать автора"**: добавлен ключ `keyboards.settings_menu.support` во все 4 языка, обновление клавиатуры | ✅ Реализовано |
| **6.9.5** | 19 апр 2026 | **Мультиязычная поддержка юридических документов**: сервис загрузки, кэширование, фоллбэк на en/ru, интеграция в /start и настройки | ✅ Реализовано |
| **6.9.3** | 19 апр 2026 | **Сообщение "Проверяю источник..."**: новый ключ локализации, улучшение UX при добавлении канала | ✅ Реализовано |
| **6.9.2** | 19 апр 2026 | Исправление локализации: синхронизация ключей (ru/en/uk/be), грамматика be, новые сообщения админ-панели | ✅ Реализовано |
| **6.9.1** | 8 апр 2026 | Блокировка источников + верификация авторства, 2 скрипта, 10 тестов | ✅ Реализовано |
| **6.9** | 8 апр 2026 | Умное превью, проверка медиа, упрощение post_sender | ✅ Реализовано |
| **6.8** | 7 апр 2026 | Прямая отправка медиа, альбомы, 3-уровневый fallback | ✅ Реализовано |
| **6.7** | 6 апр 2026 | HTML форматирование, медиа по URL, Inline кнопка | ✅ Реализовано |
| **6.6** | 2 апр 2026 | **Гибридное согласие (GDPR)**: поле `consent_given_at`, хендлеры, клавиатуры, тесты (5) | ✅ Реализовано |
...
- ✅ 112 тестов пройдено (v6.6: +5 тестов согласия, v6.4: +8 тестов лимитов)
