...
| `core/models/` | ORM модели (7 модулей) | ✅ v6.3: 9 таблиц |
| `core/services/` | Бизнес-логика | ✅ Тестируется |
| `tests/conftest.py` | Фикстуры pytest | ✅ Обновлёно |
| `pytest.ini` | Конфигурация тестов | ✅ Создано |
| `docs/README.md` | Документация (72 файла) | ✅ Актуально |
| `docs/memory/` | Память проекта (17 файлов) | ✅ v6.3 |
...
**Последнее обновление:** v6.3 (28 марта 2026) — удалена `user_cached_media`
...
### Тестирование
6. **✅ 93% тестов проходят** — 64 из 65 рабочих тестов
...
10. **✅ Покрытие бизнес-логики** — GDPR, назначения, парсеры, сервисы, rate limiting
...
**Статус:** ⏳ Ожидает (приоритет: 🟡 Средний)
...
|---------|----------|------------|
| **Строк кода (Python)** | ~8500 | +модули сервисов и утилит |
| **Файлов Python** | 85+ | +модули, +тесты |
| **Тестов** | 104 | +34 теста (destination, monitoring) |
| **Покрытие тестами** | ~75% | 99 из 104 тестов |
...
| **Документов** | 15+ | Без изменений |
| **Модулей моделей** | 7 | users, sources, subscriptions, groups, assignments, cache, base |
| **Модулей сервисов** | 25+ | cleanup, destinations, monitoring, helper, rate_limiter |
